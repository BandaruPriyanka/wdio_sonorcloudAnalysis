  ...
  afterStep: async function (Step, Scenario, result) {
    ...
    if (!result.passed) {
      if (scenarioName == "Visual testing Negative case") {
        ...
        // await attachImage("actualImages/actual/desktop_chrome-headless-shell/","Image_Negative-.png");
        await attachImage("actualImages/actual/desktop_chrome/","Image_Negative-.png");
        await attachText("Actual Image");
        // await attachImage("baselineImages/desktop_chrome-headless-shell/","Image_Negative-.png");
        ...
        // await attachImage("actualImages/diff/desktop_chrome-headless-shell/","Image_Negative-.png");
